      ...
      return (
        ...
        P(t, [
          ...
          },
          {
            key: "updateDisplay",
            value: function (e) {
              return !e && X.isActive(this.__select)
                ? this
    ...
    Q = (function (e) {
      function t(e, n, o) {
        ...
        return (
          ...
          X.bind(r.__input, "change", function () {
            var e = parseFloat(s.__input.value);
            S.isNaN(e) || s.setValue(e);
          }),
          X.bind(r.__input, "blur", function () {
            i();
          }),
          X.bind(r.__input, "mousedown", function (e) {}),
          X.bind(r.__input, "keydown", function (e) {
            var t = s.__step || 1;
            switch (e.keyCode) {
              case 13:
        ...
        P(t, [
          {
            key: "updateDisplay",
            value: function (e) {
              return !e && X.isActive(this.__input)
                ? this
        ...
        P(t, [
          {
            key: "updateDisplay",
            value: function (e) {
              if (!e && X.isActive(this.__input)) return this;
              ...
              if (!1 !== t) {
                ...
                S.each(
                  ...
                  function (e) {
                    if (
                      !S.isUndefined(t[e]) &&
                      !S.isUndefined(this.__color.__state[e]) &&
                      t[e] !== this.__color.__state[e]
                    )
                      return (n = !0), {};
                  },
                  this
                ),
                  n && S.extend(this.__color.__state, t);
              }
